...
const CONFIGS: Record<Mode, {
  ...
  sponsored: {
    ...
    dataset: {
      totalPosts: 4277, totalLabel: 'Sponsored posts analyzed', scopeNote: '100% Instagram',
      baselinePosts: 2720, anySignalPosts: 1557,
      flags: [
        { key: 'caption', label: 'School mentioned in caption', count: 861, pct: 20.1 },
        { key: 'logo', label: 'School logo in the post', count: 1209, pct: 28.3 },
        { key: 'collab', label: 'Official school collaboration', count: 118, pct: 2.8 },
      ],
    },
    anySignal: [
      { metric: 'Likes', medianLift: 39 },
      { metric: 'Video Views', medianLift: 37 },
      { metric: 'Engagement Rate', medianLift: 63 },
    ],
    signals: [
      {
        key: 'collab', name: 'Collaboration', sub: 'A formal tie to the school',
        likesMedianLift: 249, erMedianLift: 191, n: 118, verdict: 'The powerhouse',
      ...
      },
      {
        ...
        likesMedianLift: 34, erMedianLift: 69, n: 1209, verdict: 'Solid lift',
      ...
      },
      {
        ...
        likesMedianLift: 33, erMedianLift: 39, n: 861, verdict: 'Mildly positive',
    ...
    withVsWithout: {
      ...
      data: {
        collab: {
          engagement: { with: 19.0, without: 6.5, lift: 191 },
          likes: { with: 1184, without: 339, lift: 249 },
          comments: { with: 8, without: 9, lift: -11 },
        },
        logo: {
          engagement: { with: 9.8, without: 5.8, lift: 69 },
          likes: { with: 425, without: 317, lift: 34 },
          comments: { with: 9, without: 9, lift: 0 },
        },
        mention: {
          engagement: { with: 8.7, without: 6.2, lift: 39 },
          likes: { with: 442, without: 333, lift: 33 },
          comments: { with: 8, without: 9, lift: -11 },
        },
        any: {
          engagement: { with: 9.2, without: 5.6, lift: 63 },
          likes: { with: 424, without: 306, lift: 39 },
          comments: { with: 8, without: 9, lift: -11 },
        },
      },
    },
